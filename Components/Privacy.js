import { Text, View, StyleSheet, TouchableOpacity, StatusBar, Switch } from 'react-native';
  ...
  return (
    ...
    <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.Messaging}>
            ...
            <TouchableOpacity style={styles.readReciepts} onPress={() => console.log("Read Receipts")}>
            ...
            <TouchableOpacity style={styles.appSecurity} onPress={() => console.log("Typing indicator")}>
                    <View style={styles.ScreenLock_content}>
                        <Text style = {{fontSize: 15}}>
                            Typing indicators
                        </Text>
        ...
        <View style={styles.Disappearing_Messages}>
            ...
            <TouchableOpacity style={styles.appSecurity} onPress={() => console.log("Default timer")}>
                <View style={styles.ScreenLock_content}>
                    <Text style = {{fontSize: 15}}>
                        Default timer for new chat
                    </Text>
                    <Text style={{width:'90%'}}>
                        Set default disappearing message timer for all new chats started by you.
                    </Text>
                    </View>
                <View>
        ...
        <View style={styles.AppSecurity}>
            ...
            <TouchableOpacity style={styles.appSecurity} onPress={() => console.log("Screen Lock")}>
                    <View style={styles.ScreenLock_content}>
                        <Text style = {{fontSize: 15}}>
                            Screen Lock
                        </Text>
            ...
            <TouchableOpacity style={styles.appSecurity} onPress={() => console.log("Screen security")}>
                <View style={styles.ScreenLock_content}>
                    <Text style = {{fontSize: 15}}>
                        Screen Security 
                    </Text>
            ...
            <TouchableOpacity style={styles.appSecurity} onPress={() => console.log("incognito keyboard")}>
                <View style={styles.ScreenLock_content}>
                    <Text style = {{fontSize: 15}}>
                        Incognito Keyboard
                    </Text>
            ...
            <View style={{paddingBottom:15, paddingTop: 15}}>
                <Text>
                    This setting is not  guarantee and your keyboard may ignore it. Learn more
                </Text>              
            </View>
        </View>
        <View style={styles.Disappearing_Messages}>
            ...
            <TouchableOpacity style={styles.appSecurity} onPress={() => console.log("Payment Lock")}>
                <View style={styles.ScreenLock_content}>
                    <Text style = {{fontSize: 15}}>
                        Payment lock
                    </Text>
        ...
        <TouchableOpacity style={styles.appSecurity} onPress={() => console.log("Advance")}>
                <View style={styles.ScreenLock_content}>
                    <Text style = {{fontSize: 15}}>
                        Advance
                    </Text>
